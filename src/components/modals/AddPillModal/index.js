/**
 * modals/AddPillModal/index.js  ← MAIN AddPillModal ENTRY
 * ─────────────────────────────────────────────────────────
 * Composes the Add Medication modal from focused sub-parts.
 * "Time of Day" field removed (redundant — alarm time covers it).
 *
 * Sub-files:
 *  constants.js               ← frequency options + alarm tones
 *  useAddPillForm.js          ← all form state in one hook
 *  components/AlarmSection.js ← alarm toggle + time + tone picker
 * ─────────────────────────────────────────────────────────
 */
      ...
      <View style={styles.overlay}>
        <View style={styles.modal}>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            {/* Quantity + Total Days - side by side */}
            <View style={styles.row}>
              ...
              <View style={styles.halfRight}>
                ...
                <TextInput
                  ...
                  onChangeText={form.setTotalDays}
                  keyboardType="numeric"
                  placeholderTextColor="#9ca3af"
                />
              </View>
                ...
                {FREQUENCY_OPTIONS.map((opt) => (
                  ...
                  >
                    <Text style={[
                      ...
                      form.frequency === opt && styles.dropdownItemTextSelected,
                    ]}>
                      {opt}
                    </Text>
                  </TouchableOpacity>
